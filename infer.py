...
custom_model_name = './phishing_detection_model_openai_gpt'
custom_model_results_df = evaluate_model(custom_model_name, data)

gpt_model_name = 'openai-community/openai-gpt'
...
print(f"Precision of the openai-community/openai-gpt model: {gpt_model_precision:.4f}")
